...
export const WEEKLY_CONFIG: DayConfig[] = [
  {
    ...
    tasks: [
      ...
      { id: '2', title: '复习3个错别字(读写)', icon: PencilLine, color: '#58cc02', status: 'todo' },
      { id: '3', title: '完成今日学校作业', icon: BookOpen, color: '#1cb0f6', status: 'todo' },
      { id: '4', title: '选1题向家长讲思路', icon: Mic2, color: '#ff9600', status: 'todo' },
      { id: '5', title: '巩固2道今日/同类题', icon: Target, color: '#1cb0f6', status: 'todo' },
      { id: '6', title: '检查单位/答/易错点', icon: ClipboardCheck, color: '#afafaf', status: 'todo' }
    ]
  },
  {
    dayNumber: 1, // Monday
